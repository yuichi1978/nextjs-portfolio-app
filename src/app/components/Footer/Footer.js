...
import Accordian from "@/app/components/Footer/Accordian";
...
export default function Footer() {
  ...
  return (
    <div id="footer" className="mt-0 sm:mt-[90px]">
      <div className="bg-white pt-0 lg:pt-[100px]">
        <div
          className="
          max-w-[1140px] bg-blue-500 rounded-xl px-[20px] sm:px-[64px]
          py-[64px] m-auto
        "
          style={{
          ...
          <div className="grid grid-cols-12">
            ...
            <div className="col-span-12 lg:col-span-3">
              <div className="flex justify-center mt-5 lg:mt-0">
                <a
                  className="
                  font-sans cursor-pointer px-10 py-5 bg-[#01D9FF] rounded-xl
      ...
      <footer className="bg-[#223740]">
        <div
          className="
          mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 
        ...
        >
          <div className="container mx-auto p-4 md:hidden block mt-10">
            ...
            <Accordian title="Legal Polic" content={legal} />
            <div className="md:hidden block">
              ...
              <p
                className="
                mt-4 max-w-xs text-[#7B858B] font-sans text-center"
              >
                You Deserve It Be Seen!
              </p>
              <p className="text-xs text-[#7B858B] font-sans text-center">
                &copy; 2024. edubaba
              </p>
            </div>
          </div>
          ...
          <div className="grid gap-6 grid-cols-5 md:pt-20">
            <div className="md:block hidden">
              ...
              <p
                className="
                mt-4 max-w-xs text-[#7B858B] font-sans"
              >
                You Deserve It Be Seen!
              </p>
            ...
            <div className="md:block hidden">
              <p className="font-medium text-white font-sans">Service</p>
            ...
            <div className="md:block hidden">
              <p className="font-medium text-white font-sans">Legal Polic</p>
              <ul className="mt-6 space-y-4 text-sm">
                {legal.map((item) => (
                  <li key={item.id}>
                    <a className="text-[#7b858b] font-sans hover:opacity-75 cursor-pointer">
          ...
          <div
            className="
          xl:max-w-6xl 2xl:max-w-7xl px-10 md:px-20 xl:px-44 mx-auto
            ...
            <div className="flex flex-wrap justify-between items-center">
              <div className="w-1/3 sm:w-auto sm:mx-4 mb-10 sm:mb-0">
                ...
                >
                  ...
                  <h5
                    className="
                    font-recoleta mt-1 lg:mt-3 xl:mt-5 text-sm sm:text-base font-sans text-gray-200
                    transition-colors duration-300 group-hover:text-[#48AFDE]
                  "
                  >
                    Twitter
                  </h5>
