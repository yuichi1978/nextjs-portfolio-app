...
export default function DiagonalDrawer({
  ...
  // 使用パス名は、現在の URL パス名を読み取ることができるクライアント コンポーネント フック
    ...
    <React.Fragment>
      ...
      >
        <div className="relative">
          <div
            className="
            z-20 absolute transform-gpu ease-in-out duration-500 transition-all
          ...
          >
            <nav
              className="
            text-white font-recoletaBold text-center text-4xl lg:text-4xl 
              2xl:text-6xl uppercase
              "
            >
                ...
                <li className="group my-4 xl:my-4 2xl:my-6 relative">
                  <div className="inline-block relative">
                    ...
                    {selectedIndex1 === 0 ? (
                      <div
                        className="
                      absolute top-2 -left-2 w-full h-full transform-gpu transition-all duration-300
                      -rotate-6 opacity-100 group-hover:-rotate-6 group-hover:opacity-100 bg-[#48AFDE]
                      rounded-xl -z-10
                      "
                      ></div>
                    ) : (
                    ...
                    <div
                      className="
                      absolute top-2 -left-2 w-full h-full transform-gpu transition-all duration-300
                      rotate-0  opacity-0  group-hover:-rotate-6 group-hover:opacity-100 bg-[#48AFDE]
                      rounded-xl -z-10
                      "
                    ></div>
                  </div>
            ...
            <section
              className="
              mt-14 sm:mt-12 lg:mt-14 text-center relative sm:absolute lg:relative sm:right-0 
              lg:right-0 h-auto sm:h-full lg:h-auto
              "
            >
              <h3
                className="
                block sm:hidden lg:block font-bold text-[#48AFDE] text-2xl uppercase mb-5
              "
              >
                Follow Me Around
              </h3>
              <div className="flex flex-row sm:flex-col lg:flex-row">
                <a
                  href="http://twitter.com/Ehiedu_baba"
                  className="
                ...
                <a
                  href="https://github.com/yuichi1978?tab=repositories"
                  className="
                text-gray-300 hover:text-white transition-colors duration-300
                "
                >
